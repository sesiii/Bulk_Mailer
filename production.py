...
with EasyProcess(['Xvfb', ':1', '-screen', '0', '1024x768x24']) as proc:
    ...
    with app.app_context():
        for i, (name, email) in enumerate(emails):
            msg = Message(subject='Notice: Development Email - Not for Professional Use  ', sender=('Sam Altman', app.config['MAIL_USERNAME']), recipients=[email])
